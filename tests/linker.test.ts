...
Deno.test("normalizeUrls - adds absolute URLs and target=_blank", () => {
  ...
  assertEquals(
    result.includes('<a href="/dict/watermelon">watermelon</a>'),
    false,
  );
  assertEquals(
    result.includes(
...
Deno.test("purifyUrl - various cases", () => {
  ...
  assertEquals(
    purifyUrl("https://some.where/article/abc-xyz"),
    "https://some.where/article/abc-xyz",
  );
  assertEquals(
    purifyUrl("https://some.where/article/abc-xyz#name,bob"),
    "https://some.where/article/abc-xyz",
  );
  assertEquals(
    purifyUrl(
...
Deno.test("absolutifyUrl - various cases", () => {
  ...
  assertEquals(
    absolutifyUrl("https://some.where/article/abc-xyz", "category/page.html"),
  ...
  assertEquals(
    absolutifyUrl("https://some.where/article/abc-xyz"),
    "https://some.where/article/abc-xyz",
  );
});
